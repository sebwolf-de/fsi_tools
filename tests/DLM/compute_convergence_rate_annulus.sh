...
if [[ $1 == *"1"* ]]; then
  ...
  python2 dlm_master.py convergence/annulus/BDF1_dt\=1_128.json
...
if [[ $1 == *"2"* ]]; then
  ...
  python2 dlm_master.py convergence/annulus/BDF2_dt\=1_128.json
...
if [[ $1 == *"T"* ]]; then
  ...
  python2 dlm_master.py convergence/annulus/Theta_dt\=1_128.json
...
if [[ $1 == *"R"* ]]; then
  ...
  cp results/dlm_annulus_32_BDF2_dt5em4_hx32_hs32_k10_nu1/binary_data/cn_time_400 results/Convergence_Analysis_Annulus/reference
  cp results/dlm_annulus_32_BDF2_dt5em4_hx32_hs32_k10_nu1/binary_data/mesh results/Convergence_Analysis_Annulus/mesh
fi
