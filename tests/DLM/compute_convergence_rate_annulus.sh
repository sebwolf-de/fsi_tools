...
if [[ $1 == *"C"* ]]; then
  python3 dlm_fixpoint.py convergence/annulus/CN_dt\=1_2.json
  python3 dlm_fixpoint.py convergence/annulus/CN_dt\=1_4.json
  python3 dlm_fixpoint.py convergence/annulus/CN_dt\=1_8.json
  python3 dlm_fixpoint.py convergence/annulus/CN_dt\=1_16.json
  python3 dlm_fixpoint.py convergence/annulus/CN_dt\=1_32.json
fi
...
if [[ $1 == *"T"* ]]; then
  python3 dlm_fixpoint.py convergence/annulus/TR_dt\=1_2.json
  python3 dlm_fixpoint.py convergence/annulus/TR_dt\=1_4.json
  python3 dlm_fixpoint.py convergence/annulus/TR_dt\=1_8.json
  python3 dlm_fixpoint.py convergence/annulus/TR_dt\=1_16.json
  python3 dlm_fixpoint.py convergence/annulus/TR_dt\=1_32.json
fi
