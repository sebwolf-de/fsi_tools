...
if [[ $1 == *"1"* ]]; then
  ...
  cp results/dlm_annulus_32_BDF1_dt1em1_hx32_hs32_k10_nu1/binary_data/cn_time_002 results/Convergence_Analysis_Annulus/BDF1_1
  cp results/dlm_annulus_32_BDF1_dt1em1_hx32_hs32_k10_nu1/binary_data/time results/Convergence_Analysis_Annulus/BDF1_1_time

  python3 dlm_fixpoint.py convergence/annulus/BDF1_dt\=1_4.json
  cp results/dlm_annulus_32_BDF1_dt5em2_hx32_hs32_k10_nu1/binary_data/cn_time_004 results/Convergence_Analysis_Annulus/BDF1_2
  cp results/dlm_annulus_32_BDF1_dt5em2_hx32_hs32_k10_nu1/binary_data/time results/Convergence_Analysis_Annulus/BDF1_2_time
...
if [[ $1 == *"2"* ]]; then
  ...
  cp results/dlm_annulus_32_BDF2_dt1em1_hx32_hs32_k10_nu1/binary_data/cn_time_002 results/Convergence_Analysis_Annulus/BDF2_1
  cp results/dlm_annulus_32_BDF2_dt1em1_hx32_hs32_k10_nu1/binary_data/time results/Convergence_Analysis_Annulus/BDF2_1_time

  python3 dlm_fixpoint.py convergence/annulus/BDF2_dt\=1_4.json
  cp results/dlm_annulus_32_BDF2_dt5em2_hx32_hs32_k10_nu1/binary_data/cn_time_004 results/Convergence_Analysis_Annulus/BDF2_2
  cp results/dlm_annulus_32_BDF2_dt5em2_hx32_hs32_k10_nu1/binary_data/time results/Convergence_Analysis_Annulus/BDF2_2_time
...
if [[ $1 == *"T"* ]]; then
  ...
  cp results/dlm_annulus_32_Theta_dt1em1_hx32_hs32_k10_nu1/binary_data/cn_time_002 results/Convergence_Analysis_Annulus/Theta_1
  cp results/dlm_annulus_32_Theta_dt1em1_hx32_hs32_k10_nu1/binary_data/time results/Convergence_Analysis_Annulus/Theta_1_time

  python3 dlm_fixpoint.py convergence/annulus/Theta_dt\=1_4.json
  cp results/dlm_annulus_32_Theta_dt5em2_hx32_hs32_k10_nu1/binary_data/cn_time_004 results/Convergence_Analysis_Annulus/Theta_2
  cp results/dlm_annulus_32_Theta_dt5em2_hx32_hs32_k10_nu1/binary_data/time results/Convergence_Analysis_Annulus/Theta_2_time
