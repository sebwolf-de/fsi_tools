...
if [[ $1 == *"2"* ]]; then
  ...
  cp results/dlm_channel_16_BDF2_dt1em1_hx16_hs16_k50_nu0.1/binary_data/cn_time_001 results/Convergence_Analysis_Channel/BDF2_dt=1_2_result
  cp results/dlm_channel_16_BDF2_dt1em1_hx16_hs16_k50_nu0.1/binary_data/time results/Convergence_Analysis_Channel/BDF2_dt=1_2_time

  python2 dlm_master.py convergence/channel/BDF2_dt\=1_4.json
  cp results/dlm_channel_16_BDF2_dt5em2_hx16_hs16_k50_nu0.1/binary_data/cn_time_002 results/Convergence_Analysis_Channel/BDF2_dt=1_4_result
  cp results/dlm_channel_16_BDF2_dt5em2_hx16_hs16_k50_nu0.1/binary_data/time results/Convergence_Analysis_Channel/BDF2_dt=1_4_time
...
if [[ $1 == *"T"* ]]; then
  ...
  cp results/dlm_channel_16_Theta_dt1em1_hx16_hs16_k50_nu0.1/binary_data/cn_time_001 results/Convergence_Analysis_Channel/Theta_dt=1_2_result
  cp results/dlm_channel_16_Theta_dt1em1_hx16_hs16_k50_nu0.1/binary_data/time results/Convergence_Analysis_Channel/Theta_dt=1_2_time

  python2 dlm_master.py convergence/channel/Theta_dt\=1_4.json
  cp results/dlm_channel_16_Theta_dt5em2_hx16_hs16_k50_nu0.1/binary_data/cn_time_002 results/Convergence_Analysis_Channel/Theta_dt=1_4_result
  cp results/dlm_channel_16_Theta_dt5em2_hx16_hs16_k50_nu0.1/binary_data/time results/Convergence_Analysis_Channel/Theta_dt=1_4_time
