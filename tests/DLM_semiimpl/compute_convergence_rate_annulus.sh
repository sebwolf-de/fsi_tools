...
if [[ $1 == *"T"* ]]; then
  python3 dlm_semiimplicit.py params/conv/Theta_dt\=1_2.json
  python3 dlm_semiimplicit.py params/conv/Theta_dt\=1_4.json
  python3 dlm_semiimplicit.py params/conv/Theta_dt\=1_8.json
  python3 dlm_semiimplicit.py params/conv/Theta_dt\=1_16.json
  python3 dlm_semiimplicit.py params/conv/Theta_dt\=1_32.json
fi
...
cp results/dlm_annulus_16_BDF2_dt1em3_hx16_hs16_k10_nu1/binary_data/cn_time_200 results/Convergence_Analysis_Annulus/reference
cp results/dlm_annulus_16_BDF2_dt1em1_hx16_hs16_k10_nu1/binary_data/mesh results/Convergence_Analysis_Annulus/mesh
