...
if [[ $1 == *"1"* ]]; then
  ...
  cp results/ns_test_12_BDF1_d125em6_hx12_nu1/binary_data/cn_time_0016 results/Convergence_Analysis_Test/BDF1_4
...
cp results/ns_test_12_BDF1_dt1em5_hx12_nu1/binary_data/mesh results/Convergence_Analysis_Test/mesh
cp results/ns_test_12_BDF1_dt1em5_hx12_nu1/binary_data/cn_time_0200 results/Convergence_Analysis_Test/reference
